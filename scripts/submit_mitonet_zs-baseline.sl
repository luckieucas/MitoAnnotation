#!/bin/bash
#SBATCH --job-name=mitonet_zs_baseline        # Job name
...
#SBATCH --output=logs/%j_mitonet_zs_baseline.out  
...
python auto_train_nnunet.py --data_folder /projects/weilab/dataset/MitoLE/cellmap24_cardiac --output_dir /projects/weilab/liupeng/nnUNet --dataset_id Dataset004_MitoHardCardiac --fold all --skip_convert --skip_boundary --skip_plan --skip_training
# Print end time
