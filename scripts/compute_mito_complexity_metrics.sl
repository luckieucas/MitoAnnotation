...
python -u src/evaluation/evaluate_dataset_difficult.py  /projects/weilab/dataset/MitoLE --output-dir /projects/weilab/liupeng/dataset/mito/complexity/ --datasets-hard  MitoEM-H --compute-contact-count
# Print end time
